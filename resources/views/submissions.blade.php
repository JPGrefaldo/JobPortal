    ...
    <main class="float-left w-full py-md md:py-lg px-3">
        <div class="container">
            <div class="w-full pb-8 border-b-2 mb-8 border-grey-light md:flex justify-between items-center">
                ...
                <a href="#" class="btn-green-outline">Add new project</a>
            </div>

            <div class="md:hidden w-full md:w-1/4 float-left md:mb-3">
                <div class="has-menu relative">
                    <div class="flex justify-between justify-center items-center rounded-lg w-full float-left mb-4 py-3 px-3 border border-grey-light bg-white cursor-pointer text-sm">All projects
            ...
            <aside class="hidden md:block w-1/4 float-left pr-4">
                <ul class="list-reset font-header text-left py-6">
                    <li class="block py-4">
                        <a href="#" class="border-b-2 border-red text-blue-dark font-semibold py-2 hover:text-green">All projects
                            <div class="badge bg-white ml-2">12</div>
                        </a>
                    </li>
                    <li class="block py-4">
                        <a href="#" class="text-blue-dark font-semibold py-2 hover:text-green">Active projects
                            <div class="badge bg-white ml-2">12</div>
                        </a>
                    </li>
                    <li class="block py-4">
                        <a href="#" class="text-blue-dark font-semibold py-2 hover:text-green">Inactive projects
                            <div class="badge bg-white ml-2">12</div>
                        </a>
                    </li>
                    <li class="block py-4">
                        <a href="#" class="text-blue-dark font-semibold py-2 hover:text-green">Pending projects
                            <div class="badge bg-white ml-2">12</div>
                        </a>
                    </li>
                </ul>
                ...
                <div class="">
                    <h4 class="text-grey leading-loose">Need help?
                        <br>
                        <a href="#" class="text-green">Contact support</a>
                    </h4>
                </div>
            </aside>
