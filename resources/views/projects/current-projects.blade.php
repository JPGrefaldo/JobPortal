            ...
            <div class="p-8">
                <div class="w-full mb-6 flex justify-between">
                    <h3 class="text-blue-dark font-semibold text-lg mb-1 font-header">
                        Audio commercial
                        <span class="badge">24 submissions</span>
                    </h3>
                ...
                <div class="flex">
                    ...
                    <div class="w-3/4">
                        <p>
                            Looking for an experienced gaffer who is easy going and able to roll with the punches to work alongside a great crew...
            ...
            <div class="bg-grey-lighter pb-4 px-8 border-t border-grey-light rounded-b">
                <div class="flex justify-between items-center pt-5">
                    <div>
                        <a href="#" class="h4">
                            2 ROLES
                            <span class="btn-toggle inline-block ml-1"></span>
                        </a>
            ...
            <div class="bg-grey-lighter pb-8 px-8 border-t border-grey-light rounded-b">
                ...
                <div class="bg-white mt-4 rounded p-8 shadow">
                    ...
                    <div class="flex pt-6 mt-6 border-t-2 border-grey-lighter items-center justify-end">
                        <a href="#" class="btn-outline bg-green text-white p-4">apply</a>
                    </div>
                </div>
                <div class="bg-white mt-4 rounded p-8 shadow">
                    <div class="flex justify-between items-center">
                        <h3 class="text-blue-dark font-semibold text-md mb-1 font-header">
                            Gaffer <span class="badge">1 needed</span>
                        </h3>
                        <div>
                            <span class="h4 mr-2 text-yellow inline-block text-xs">
                                <i class="fas fa-pause mr-1"></i>paused
