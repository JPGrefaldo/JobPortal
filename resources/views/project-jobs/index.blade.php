    ...
    <main class="float-left w-full py-md md:py-lg px-3">
        <div class="container">
            ...
            <div class="w-1/4 float-left pr-8 py-md hidden md:block">
                ...
                <p>The more people endorse that you, the higher chance of you being selected for the job.</p>
                <div class="py-lg">
            ...
            <div class="md:w-3/4 float-left">
                <div class="card mb-8">
                    ...
                    <div class="md:flex py-3">
                        ...
                        <form action="/projects/1/jobs/1/" method="post">
                            {{ csrf_field() }}
                            <div class="md:w-2/3">
                                <input type="text" class="form-control w-full" name="endorsee_email" placeholder="Endorsee Email">
                            </div>
