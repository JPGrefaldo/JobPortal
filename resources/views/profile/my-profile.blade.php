    ...
    <div class="container">
        ...
        <div class="w-full md:w-3/4 float-left">
            <a href="{{ route('profile-edit', ['id' => Auth::user()->id]) }}"
               class="text-grey w-full mb-2 text-sm md:text-right float-right" id="edit-profile"><i
                        class="fas fa-pencil-alt mr-2"></i>Edit profile</a>
            <div class="card float-left md:flex mb-8">
                    ...
                    <ul class="list-reset py-4">
                        ...
                        <li class="py-1">
                            @if (isset($linkedin->url))
                                <a href="http:\\linkedin.com\{{ $linkedin->url }}" target="_blank"
                                   class="flex items-center text-blue-linkedin">
                ...
                <div class="md:w-3/4">
                    ...
                    <h3 class="text-blue-dark font-semibold text-lg mb-1 font-header">{{ Auth::user()->nickname }}</h3>
            ...
            @foreach ($all_post as $post)
                @include('profile.my-profile-positions')
            @endforeach
