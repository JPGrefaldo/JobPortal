<template>
    <div>
        ...
        <div v-if="jobs.length > 0">
            <project-job-edit v-for="job in jobs" :key="job.id" :projectJob="job"></project-job-edit>
        </div>
    </div>
</template>
...
<script>
    ...
    import ProjectJobEdit from './ProjectJobEdit.vue'

    export default {
        components: {
            'project-job-edit' : ProjectJobEdit
        },
