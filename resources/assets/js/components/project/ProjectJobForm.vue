  ...
  <div>
    <div class="md:flex py-2">
      <div class="md:w-1/3 pr-8">
        <span
          class="font-bold font-header text-blue-dark mt-2 block md:text-right mb-3"
        >Persons needed</span>
      </div>
      <div class="md:w-2/3">
    ...
    <div class="md:flex py-2">
      <div class="md:w-1/3 pr-8">
        <span
          class="font-bold font-header text-blue-dark mt-4 block md:text-right mb-3"
    ...
    <div class="md:flex py-2">
      <div class="md:w-1/3 pr-8">
        ...
        <small
          class="block md:text-right text-red"
          v-show="errors.has('Pay Rate')"
        >{{ errors.first('Pay Rate') }}</small>
        <small
          class="block md:text-right text-red"
          v-show="errors.has('Pay Rate Type')"
        >{{ errors.first('Pay Rate Type') }}</small>
      </div>
      <div class="md:w-2/3">
        $
        <input
    ...
    <div class="md:flex py-2">
      <div class="md:w-1/3 pr-8">
        <span
          class="font-bold font-header mt-2 text-blue-dark block md:text-right mb-3"
