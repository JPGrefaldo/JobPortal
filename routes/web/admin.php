...
// api
Route::put('/admin/users/ban/{user}', [AdminUserController::class, 'updateBan'])->name('admin.users.ban');

// web
Route::get('/admin/flag-messages', [PendingFlagMessageController::class, 'index'])->middleware('role:Admin')->name('admin.messages.flagged.index');
